...
module ActionMailbox::InboundEmail::QueryMethodsReturningRelation
  ...
  sig { params(args: Symbol).returns(ActionMailbox::InboundEmail::ActiveRecord_Relation) }
...
module ActionMailbox::InboundEmail::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: Symbol).returns(ActionMailbox::InboundEmail::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end
